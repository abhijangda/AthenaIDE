...
class newprojectwin(QtGui.QDialog):
    ...
    def list_widget_first_proj_type_item_clicked(self, item):
        ...
        if str(item.text())=="C":
            item = QtGui.QListWidgetItem(QtGui.QIcon("./icons/c_file.png"),"C Project")
            self.list_widget_second_proj_type.insertItem(0,item)
            
            item = QtGui.QListWidgetItem(QtGui.QIcon("./icons/gtk.png"),"GTK+ Project")
            self.list_widget_second_proj_type.insertItem(1,item)

        else:
            item = QtGui.QListWidgetItem(QtGui.QIcon("./icons/cpp_file.png"),"C++ Project")
            self.list_widget_second_proj_type.insertItem(0,item)

            item = QtGui.QListWidgetItem(QtGui.QIcon("./icons/gtk.png"),"gtkmm Project")
            self.list_widget_second_proj_type.insertItem(1,item)
