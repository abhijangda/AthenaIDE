...
###############################################################
        ...
        commentout_multiline = QtGui.QAction(QtGui.QIcon('commentout.png'),'Multi-Line Comment Out Region',self)
        ...
        uncommentout_multiline = QtGui.QAction(QtGui.QIcon('uncommentout.png'),'Multi-Line Uncomment Out Region',self)
        ...
        commentout_singleline = QtGui.QAction(QtGui.QIcon('commentout.png'),'Single-Line Comment Out Region',self)
        self.connect(commentout_singleline, QtCore.SIGNAL('triggered()'),self.commentout_singleline_triggered)
        
        uncommentout_singleline = QtGui.QAction(QtGui.QIcon('commentout.png'),'Single-Line Uncomment Out Region',self)
        ...
        uppercaseselection = QtGui.QAction(QtGui.QIcon('uppercase.png'),'Uppercase Selection',self)
        ...
        lowercaseselection = QtGui.QAction(QtGui.QIcon('lowercase.png'),'Lowercase Selection',self)
        ...
        close_project=QtGui.QAction(QtGui.QIcon('project_close.png'),'Close Project',self)
        self.connect(close_project,QtCore.SIGNAL('triggered()'),self.close_project_triggered)       
        
        projectmanager = QtGui.QAction(QtGui.QIcon('project_options.png'),'Project Preferences',self)
        ...
        newprojectaction = QtGui.QAction(QtGui.QIcon('project_new.png'),'New Project',self)
        ...
        openproj = QtGui.QAction(QtGui.QIcon('project_open.png'),'Open Project',self)
        ...
        self.gdb_run = QtGui.QAction(QtGui.QIcon('gdb_run.png'),"Run with GDB",self)
        self.connect(self.gdb_run,QtCore.SIGNAL('triggered()'),self.gdb_run_triggered)
                                                                                      
        self.gdb_continue=QtGui.QAction(QtGui.QIcon('continue.png'),'Continue',self)
        self.connect(self.gdb_continue,QtCore.SIGNAL('triggered()'),self.gdb_continue_triggered)
        
        self.gdb_stop=QtGui.QAction(QtGui.QIcon('stop.ico'),'Stop',self)
        self.connect(self.gdb_stop,QtCore.SIGNAL('triggered()'),self.gdb_stop_triggered)
        
        self.gdb_breakpoint_new=QtGui.QAction(QtGui.QIcon('breakpoint-new.png'),'New Breakpoint',self)
        self.connect(self.gdb_breakpoint_new,QtCore.SIGNAL('triggered()'),self.gdb_breakpoint_new_triggered)
        
        self.gdb_breakpoint_enable_all=QtGui.QAction(QtGui.QIcon('breakpoint-enableall.png'),'Enable All Breakpoints',self)
        self.connect(self.gdb_breakpoint_enable_all,QtCore.SIGNAL('triggered()'),self.gdb_breakpoint_enable_all_triggered)
        
        self.gdb_breakpoint_disable_all=QtGui.QAction(QtGui.QIcon('breakpoint-disableall.png'),'Disable All Breakpoints',self)
        self.connect(self.gdb_breakpoint_disable_all,QtCore.SIGNAL('triggered()'),self.gdb_breakpoint_disable_all_triggered)
        
        self.gdb_breakpoint_remove_all=QtGui.QAction(QtGui.QIcon('breakpoint-removeall.png'),'Remove All Breakpoints',self)
        self.connect(self.gdb_breakpoint_remove_all,QtCore.SIGNAL('triggered()'),self.gdb_breakpoint_remove_all_triggered)
        
        self.gdb_next=QtGui.QAction(QtGui.QIcon('next.ico'),'Next',self)
        self.connect(self.gdb_next,QtCore.SIGNAL('triggered()'),self.gdb_next_triggered)
        
        self.gdb_step_out=QtGui.QAction(QtGui.QIcon('step_out.ico'),'Step Out',self)
        self.connect(self.gdb_step_out,QtCore.SIGNAL('triggered()'),self.gdb_step_out_triggered)
        
        self.gdb_step=QtGui.QAction(QtGui.QIcon('step.ico'),'Step',self)
        self.connect(self.gdb_step,QtCore.SIGNAL('triggered()'),self.gdb_step_triggered)
        
        self.gdb_step_into_asm=QtGui.QAction(QtGui.QIcon('step_into_asm.ico'),'Step into asm',self)
        self.connect(self.gdb_step_into_asm,QtCore.SIGNAL('triggered()'),self.gdb_step_into_asm_triggered)
        
        self.gdb_step_over_asm=QtGui.QAction(QtGui.QIcon('step_over_asm.ico'),'Step over asm',self)
...
#Project Menu Functions
    ...
    def close_project_triggered(self):
        ...
        msg = QtGui.QMesssageBox.question(self,'Close Project','Do you want to close the current project?',QtGui.QMessageBox.Yes,QtGui.QMessageBox.No)
        if msg == QtGui.QMessageBox.Yes:
    ...
    def projmanager_close_event(self,state):
        ...
        if state==1:
            ...
            for i in range(self.winprojmanager.listViewDirs.count()):
                self.current_proj.list_dir.append(str(self.winprojmanager.listViewDirs.item(i).text()))
                ...
                if self.mode == 'Project':
                    if self.checkboxarray[i].isChecked() == True:
                        ...
                        if self.current_proj.list_files[self.tracktabsarray[self.notsavedarray[i]]] != '':
                            ...
                            f.write(str(self.current_proj.list_files[self.notsavedarray[i]].txtInput.toPlainText()))
                            f.close()
                        else:
                            self.tabs.setCurrentIndex(self.notsavedarray[i])
                            self.savedialog()
