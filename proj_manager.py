...
class ProjManagerDlg(QtGui.QDialog):
    ...
    def __init__(self, proj_file, parent= None):
        ...
        self.cmdRemoveAll.setGeometry(QtCore.QRect(650, 330, 95, 31))
        
        self.cmdRemoveFile = QtGui.QPushButton("Remove File",self.tabGeneral)
        self.cmdRemoveFile.setGeometry(QtCore.QRect(650, 230, 95, 31))
        ...
        self.cmdAddFile = QtGui.QPushButton("Add File",self.tabGeneral)
        self.cmdAddFile.setGeometry(QtCore.QRect(650, 180, 95, 31))
        
        self.listViewFiles = QtGui.QListWidget(self.tabGeneral)
        self.listViewFiles.setGeometry(QtCore.QRect(100, 130, 541, 301))
        
        self.cmdRenameFile = QtGui.QPushButton('Rename File',self.tabGeneral)
        self.cmdRenameFile.setGeometry(QtCore.QRect(650, 280, 95, 31))
